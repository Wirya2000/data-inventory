...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'List Pembelian'])
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table id="tablePembelian" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <a href="/pembelians/{{ $data->id }}/edit" class="badge bg-warning">
