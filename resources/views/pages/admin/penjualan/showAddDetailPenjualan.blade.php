{{-- <row>
    <div class="col-md-4">
        <button type="button" class="btn btn-block btn-default mb-3" data-bs-toggle="modal" data-bs-target="#modalAddDetailPenjualan">Form</button> --}}
        <div class="modal fade" id="modalAddDetailPenjualan" tabindex="-1" role="dialog" aria-labelledby="modalAddDetailPenjualan" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            ...
            <div class="modal-body p-0">
                ...
                <div class="card-body">
                    <form method="POST" id="addDetailForm" enctype="multipart/form-data" role="form text-left">
                        ...
                        <div class="text-center">
                            <button type="button" class="btn btn-round bg-gradient-info btn-lg w-100 mt-4 mb-0" onclick="updateTableDetailPenjualan()">Add Barang</button>
                        </div>
                    </form>
                </div>
