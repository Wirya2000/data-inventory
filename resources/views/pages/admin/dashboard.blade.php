        ...
        <div class="row">
                    ...
                    <div class="card-body p-3">
                        <div class="numbers">
                            ...
                            <p class="text-sm text-muted">
                                Margin Profit: {{ number_format($margin, 2) }}%
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-body p-3">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Stok Menipis</p>
                            ...
                            <tbody>
                                @foreach ($topBarang as $barang)
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format($barang->total_penjualan, 0, ',', '.') }}</td>
                                    </tr>
                                @endforeach
...
@push('js')
    ...
    <script>
        ...
        //     },
        // });
        var labels = {!! json_encode($grafik7Hari->pluck('tanggal')) !!};
        var dataPenjualan = {!! json_encode($grafik7Hari->pluck('penjualan')) !!};
